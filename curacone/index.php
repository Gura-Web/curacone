...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Asap|M+PLUS+1p" rel="stylesheet">
</head>
<body>
  <!-- <header>
    ...
    <main class="deco">
      ...
      <!-- <div calss="modal">
        <p class="modal__thumb"><img src="img/img-sample.png" alt=""></p>
        <div class="modal__info">
          <div calss="work">
            <h4 calss="work__title">タイポグラフィアート</h4>
            <p calss="work__url"><a href="">https://dribbble.com/shots/6355293-Travel-Page-Animation</a></p>
            <p calss="work__text">
          ...
          <div class="creator">
            ...
            <button class="btn btn--blue">プロフィールを見る</button>
          </div>
        </div>
        <div class="modal__comment">
          <h4>みんなのコメント</h4>
          <ul class="comment">
            <li class="commnet__list">
              <p class="commnet-list__icon"><img src="img/icon-sample.png" alt=""></p>
              <p class="commnet-list__text">聖書第１章、 はじめに神は天と地とを創造された。 2 地は形なく、むなしく、やみが淵のおもてにあり、神の霊が水のおもてをおおっていた。</p>
            </li>
            <li class="commnet__list">
              <p class="commnet-list__icon"><img src="img/icon-sample.png" alt=""></p>
              <p class="commnet-list__text">聖書第１章、 はじめに神は天と地とを創造された。 2 地は形なく、むなしく、やみが淵のおもてにあり、神の霊が水のおもてをおおっていた。</p>
          ...
          <div class="comment-submit">
            ...
            <p class="comment-submit__bar"><img src="img/icon-sample.png" alt=""><input type="text"></p>
          </div>
        </div>
      </div> -->
